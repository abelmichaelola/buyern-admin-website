...
], price:{currency:"₦",main:20.00}
}

var getProductData = (id: string, name: string, price?:{currency?:string,main?:number}): Product => {
    return {
    id:id,
    name:name,
    isAvailable:true,
    items: [
        {id:"foodItemId", about:"Amala is made from cassava flake only", isAvailable:true, name:"Amala",quantity:20, price:price},
        {id:"foodItemId", about:"lalala", isAvailable:true, name:"Ewedu",quantity:undefined, price:price},
        {id:"foodItemId", about:"Stewer", isAvailable:true, name:"Fish Stew",quantity:undefined, price:price},
        {id:"foodItemId", about:"meater", isAvailable:true, name:"Meat",quantity:20, price:price},
        {id:"foodItemId", about:"ponmoer", isAvailable:true, name:"Ponmo",quantity:20, price:price},
        {id:"foodItemId", about:"fisher", isAvailable:true, name:"Fish",quantity:20, price:price},
        {id:"foodItemId", about:"spagger", isAvailable:true, name:"Spaghetti",quantity:undefined, price:price},
        {id:"foodItemId", about:"beanser", isAvailable:true, name:"Beans",quantity:undefined, price:price},
], price:price
    }
};
