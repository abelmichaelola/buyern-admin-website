import styles from './BusinessRegisterationPage.module.scss';
import React, { ChangeEvent, Component } from 'react';
import OverlayPageView from '../ui/OverlayPageView/OverlayPageView';
import axios from 'axios';
import { BiImageAdd, BiTrashAlt, BiInfoCircle, BiCheck, BiStore } from 'react-icons/bi';
import { NavLink } from 'react-router-dom';
import { emailOnChange, firstNameOnChange, phoneCodeOnChange, phoneOnChange, addressOnChange, zipCodeOnChange, countryOnChange, stateOnChange, cityOnChange } from '../SignupPage/signUpValidator';
...
class BusinessRegisterationPage extends Component<Props, State> {
  ...
  render() {
    return (
      <OverlayPageView>
        <div className={styles.BusinessRegisterationPage + " " + styles.main + " scrollbarHandle"}>
          <div className={styles.titles}>
            <div>
              <div className={"TitleHolder1"}>BUYERN</div>
              <div className={"TitleHolder2"}>BUSINESS REGISTRATION</div>
            </div>
          </div>
          ...
          <form>
            ...
            <div className={styles.formItem}>
              <div className={"TitleHolder2"}>Details</div>
            </div>

              <div className={styles.formItem}>
                <label><span>*</span> Business Name: </label>
                <input type={"text"} id={"firstName"} name={"firstName"} placeholder={"Business Name"} onChange={(event: ChangeEvent<HTMLInputElement>) => { firstNameOnChange(event.target.value, this) }} required={true} />
                <span className={styles.ErrorMsg}>{this.state.firstNameErrMsg !== undefined ? this.state.firstNameErrMsg : ""}</span>
              </div>
            <div className={styles.formItem}>
              <label><span>*</span> About Business: </label>
              <textarea id={"dob"} name={"dob"} className={"scrollbarHandle"} placeholder={"Brief speech about Buyern..."} required={true} />
            ...
            <div className={styles.formItem + " " + styles.phoneCode}>
              <label><span>*</span> Business Type: </label>
              <select id="phoneCode" name="phoneCode">
                <option value="1">Eatery</option>
                <option value="2">Ecommerce</option>
                <option value="3">Haulage</option>
                <option value="4">Logistics</option>
                <option value="5">Device Repair</option>
                <option value="6">Shoe Maker</option>
                <option value="7">Photogragher</option>
                <option value="8">Videogragher</option>
                <option value="9">Youtuber</option>
              </select>
              <span className={styles.ErrorMsg}>{this.state.phoneCodeErrMsg !== undefined ? this.state.phoneCodeErrMsg : ""}</span>
            </div>

            <div className={styles.formItem}>
              <div className={"TitleHolder2"}>Contact</div>
            </div>

            <div className={styles.formItem}>
              <label><span>*</span> Business Email: </label>
              <input type={"text"} id={"email"} name={"email"} placeholder={"Business Email"} required={true} defaultValue={this.state.email} onChange={(event: ChangeEvent<HTMLInputElement>) => { emailOnChange(event.target.value, this) }} />
            ...
            <div className={styles.formItem}>
              <div className={"TitleHolder2"}>Location</div>
            </div>
            ...
            <div className={styles.formItem}>
              <label><span>*</span> Business Cover Image (jpg/png): </label>
              <div className={styles.image+ " " + styles.cover} onClick={this.performImageClick.bind(this)} tabIndex={0} onKeyDown={(event) => { this.handleImgFocus(event) }}>

                <img className={this.state.isImageSelected ? (styles.show) : (styles.hide)} src={this.state.imageLocalLink} id={"target"} alt={"profile"} />
                <div className={this.state.isImageSelected ? (styles.hide) : (styles.show + " " + styles.coverImg)}><BiImageAdd /></div>
              </div>
            ...
            <div className={styles.formItem}>
              <div className={"TitleHolder2"}>Additional Details</div>
            </div>

            <div className={styles.formItem}>
              <div className={styles.container}>
                <input type={"checkbox"} id={"email"} defaultChecked={true} name={"email"} />
                <div className={styles.checkmark}><BiCheck /></div>
            ...
            <div className={styles.formItem}>
              <div className={styles.container}>
                ...
                <div className={styles.checkmark}><BiCheck /></div>
                <span>run promotions and adverts for me</span>
              </div>
            </div>
            ...
            <div className={styles.formItem}>
              <div className={styles.container}>
                <input type={"checkbox"} id={"email"} defaultChecked={false} name={"email"} />
                <div className={styles.checkmark}><BiCheck /></div>
                <span>Works from multiple Locations</span>
              </div>
            </div>
            ...
            <div className={styles.formItem}>
              <div className={styles.container}>
                <input type={"checkbox"} id={"email"} defaultChecked={false} name={"email"} />
                <div className={styles.checkmark}><BiCheck /></div>
                <span>Has subsediaries, branches etc</span>
              </div>
            </div>
            ...
            <div className={styles.formItem}>
              ...
              <div className={styles.blockIconButtonHolder}>
                ...
                |
                <div className={styles.blockIconButton} tabIndex={0}><span>{"T's & C's"}</span></div>
            ...
            <div className={styles.formItem}>
              <label><span>* Note: Additional settings can be found in the settings menu. These setting can also be changed later </span></label>
            </div>
...
export default BusinessRegisterationPage;